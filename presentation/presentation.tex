...
\begin{frame}[fragile]{Calculation with random variables}
    ...
    \begin{center}
     ...
     \end{center}
	 \begin{flalign*}
     	&\hspace*{1em} P10_X = 1.1 \hspace*{4em} P10_Y = 1.1 \hspace*{4em}  P10_Z = 1.45 \\
	 	&\hspace*{1em} E(X) = 1.5  \hspace*{4.2em} E(Y) = 1.5  \hspace*{4.3em}  E(Z)= 3 \\
     	&\hspace*{1em} P90_X = 1.9 \hspace*{4em} P90_Y = 1.9 \hspace*{4em}  P90_Z = 2.55 \\
	\end{flalign*}
\end{frame}
...
\begin{frame}[fragile]{Statistical Concepts}
	\begin{easylist}[itemize]
		# To handle uncertainty or risk in a consistent way, some knowledge about probability, PDFs or CDFs are needed
		# Four common probability distributions are: uniform, triangular, normal, lognormal
